...
namespace Mokkivarausjarjestelma
{
    public partial class Form1 : Form
    {
        ...
        private void btnToimintaLisaaAlue_Click(object sender, EventArgs e)
        {
            ...
            {
                if (tb.Text == "") // Tarkistaa onko panelin sis‰ll‰ olevat textiboxit t‰ytetty, jos ei ole antaa virheilmoituksen.
                {
                    tb.Focus();
                    MessageBox.Show("Kaikkia kentti‰ ei ole t‰ytetty oikein.");
                    return;
                }
            }
